...
from tests.Helper.Automate_Fuctionalities.Login import login_account_chrome
from tests.utils.Read_Data import read_data_of_cell


#1.When no Product Added
def filter_button_no_product_add():
    ...
    try:
        pro_page.find_element(By.CLASS_NAME,Product_Page.filter_button_class()).click()
        time.sleep(5)
